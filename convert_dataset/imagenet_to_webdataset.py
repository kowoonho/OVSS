...
parser.add_argument("--splits", default="val", help="which splits to write")
parser.add_argument(
    "--filekey", action="store_true", help="use file as key (default: index)"
)
parser.add_argument("--maxsize", type=float, default=1e9)
parser.add_argument("--maxcount", type=float, default=5000)
parser.add_argument(
    "--shards", default="/workspace/Dataset/local_data/imagenet_shards", help="directory where shards are written"
)
parser.add_argument(
    "--data",
    default="/workspace/Dataset/local_data/Imagenet",
